...
The **Museum With No Frontiers — Scientific Objects** gallery, built from the published
dataset `@museumwnf/scientific-objects-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/scientific-objects-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/scientific-objects/> through the reusable workflows in
