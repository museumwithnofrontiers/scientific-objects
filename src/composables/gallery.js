...
// `useGalleryData.js` used to be byte-identical local copies of what scientific-objects
...
// legacy project key, no UUID — scientific-objects shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (scientific-objects-data 1.0.11+), an outside
