...
const about = {
  body: 'scientificObjects.about.body',
...
export default {
  ...
  home: {
    title: 'scientificObjects.identity.title',
    intro: 'scientificObjects.home.intro',
    cards: [
      {
        title: 'scientificObjects.nav.catalogue',
        description: 'scientificObjects.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'scientificObjects.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'scientificObjects.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'scientificObjects.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'scientificObjects.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'scientificObjects.partnerObjects.emptyPartner',
  //         emptyInstitution: 'scientificObjects.partnerObjects.emptyInstitution',
  //         institutionSummary: 'scientificObjects.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'scientificObjects.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'scientificObjects.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
